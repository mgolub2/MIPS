...
add wave -noupdate /mips_testbench/cpu/control_logic/ex_forward_b
add wave -noupdate /mips_testbench/cpu/control_logic/rs_last
add wave -noupdate /mips_testbench/cpu/control_logic/rt_last
add wave -noupdate /mips_testbench/cpu/control_logic/rd_last
add wave -noupdate /mips_testbench/cpu/control_logic/rs_last_last
add wave -noupdate /mips_testbench/cpu/control_logic/rt_last_last
add wave -noupdate /mips_testbench/cpu/control_logic/rd_last_last
add wave -noupdate /mips_testbench/cpu/control_logic/op_last
add wave -noupdate /mips_testbench/cpu/control_logic/op_last_last
add wave -noupdate /mips_testbench/cpu/control_logic/func_last
