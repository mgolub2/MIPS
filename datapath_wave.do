...
add wave -noupdate -radix decimal /datapath_testbench/dut/clk
add wave -noupdate -radix decimal /datapath_testbench/Instructions
add wave -noupdate -radix decimal /datapath_testbench/dut/registerFile/RegWrite
add wave -noupdate -radix decimal /datapath_testbench/dut/SE/out
add wave -noupdate -radix decimal /datapath_testbench/dut/RegDst
add wave -noupdate -radix decimal /datapath_testbench/dut/RegWr
add wave -noupdate -radix decimal /datapath_testbench/dut/ALUsrc
add wave -noupdate -radix decimal /datapath_testbench/dut/MemWr
add wave -noupdate -radix decimal /datapath_testbench/dut/MemToReg
add wave -noupdate -radix decimal /datapath_testbench/dut/ALUcntrl
add wave -noupdate -radix decimal /datapath_testbench/dut/Instructions
add wave -noupdate -radix decimal /datapath_testbench/dut/Zero
...
update
WaveRestoreZoom {484039 ps} {711367 ps}
